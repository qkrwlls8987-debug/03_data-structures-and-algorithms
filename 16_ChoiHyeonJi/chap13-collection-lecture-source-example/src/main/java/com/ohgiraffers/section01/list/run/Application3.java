...
public class Application3 {
  ...
  public void run(){
    ...
    do{
      ...
      System.out.println("8. 책 대여");
      System.out.println("9. 책 반납");
      System.out.println("10. 장르 기반 추천");
      System.out.println("11. 줄거리 보기");
      System.out.println("12. 독자 정보 조회");
      ...
      try{
        ...
        switch(input){
          ...
          case 8: rentBook(); break;
          case 9: returnBook(); break;
          case 10: recommendBook(); break;
          case 11: showSummary(); break;
          case 12: getReaderInfo(); break;
          case 0:
  ...
  private void rentBook() {
    ...
    System.out.print("독자 ID 입력 : ");
    int readerId = sc.nextInt(); sc.nextLine();

    ReaderDTO reader = bookService.getReaderById(readerId);
    if(reader == null){
      System.out.println("해당 독자가 존재하지 않습니다.");
      return;
    }
    ...
    boolean success = bookService.rentBook(bookNumber, reader);

    if(success) System.out.println("대여 완료!");
    else System.out.println("대여 실패 (이미 대여중 or 연령 제한 또는 도서 없음)");
  }
  private void returnBook() {
    ...
    boolean success = bookService.returnBook(bookNumber);

    if(success) System.out.println("반납 완료!");
    else System.out.println("반납 실패 (이미 반납된 책이거나 존재하지 않음)");
  }
  ...
  private void recommendBook() {
    ...
    List<BookDTO> result = bookService.recommendByGenre(reader);
  ...
  private void showSummary() {
    ...
    System.out.println("줄거리 : " + book.getSummary());
  }
