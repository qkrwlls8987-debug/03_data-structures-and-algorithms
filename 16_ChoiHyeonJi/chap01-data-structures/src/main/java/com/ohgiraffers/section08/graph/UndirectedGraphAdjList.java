 ...
 */
public class UndirectedGraphAdjList { //행렬 모양 ㄴㄴ 리스트 이용해서 관리 // 리스트 안에 리스트로 관리
  // 그래프의 총 정점(노드) 개수
  ...
  public static void main(String[] args) {
    ...
    graphList.removeEdge(0, 3); //adjList.get(0).get(3)  adjList.get(3).get(0)
    graphList.printGraph();
    System.out.println();
    ...
    // active.set(2,false); adjList.get(2).get(0~4) or adjList.get(2).clear() 2번에 있는 기록된 내용 다 지우기
    graphList.printGraph();
    System.out.println();
  }
}
