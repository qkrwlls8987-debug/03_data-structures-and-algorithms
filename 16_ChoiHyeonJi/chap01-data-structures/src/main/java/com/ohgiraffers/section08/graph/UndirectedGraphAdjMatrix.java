...
* - matrix[i][j] = true -> 정점 i와 j가 연결되어 있음을 의미
...
public class UndirectedGraphAdjMatrix {
  // 그래프의 총 정점(노드) 개수
  private int vertices; // 이 그래프에 정점이 몇 개?
  // 인접 행렬. 각 정점 쌍의 연결 여부를 boolean 값으로 저장
  private boolean[][] matrix; //2차원 배열 행렬 표시 메트릭스
  ...
  public static void main(String[] args) {
     ...
     * 2 -- 3
     */
    graphMatrix.addEdge(0, 1); //매개변수 이름 u,v u와 v를 연결
