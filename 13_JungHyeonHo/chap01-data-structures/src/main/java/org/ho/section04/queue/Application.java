...
public class Application {
  public static void main(String[] args) {
    ...
    * 그 중 LinkedList를 사용하여 연결 리스트 기반 큐를 사용해 볼 예정
