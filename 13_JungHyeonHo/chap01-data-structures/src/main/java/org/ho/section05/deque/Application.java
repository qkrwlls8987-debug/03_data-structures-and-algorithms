...
*  - 스택(Last In First Out), 큐 (First In First Out)의 기능을 모두 수행할 수 있음.
*
*    주요 연산:
...
public class Application {
  public static void main(String[] args) {
    ...
    System.out.println("getFirst() 결과 : " + deque.getLast());
    System.out.println("getXXX() 동작 이후 deque : " + deque);

    System.out.println("===== 덱의 맨 앞/뒤 요소 확인 - removeFirst, removeLast =====");
    System.out.println("removeFirst() 결과 : " + deque.removeFirst()); // 5
    System.out.println("removeLast() 결과 : " + deque.removeLast()); // 4
    System.out.println("getXXX() 동작 이후 deque : " + deque); // [1, 2, 3]


    System.out.println("===== 덱의 비어있는지 확인 - isEmpty =====");
