...
public class Application {
  ...
  public static void main(String[] args) {
    ...
    * 그 중 LinkedList 를 사용하여 연결 리스트 기반 큐를 사용해볼 예정
    * LinkedList는 DoublyLinkedList 기반으로, Queue연산(offer, poll)에 효율적임
    * */

    System.out.println("----- 큐에 요소 추가 - offer() -----");
    // boolean offer(E e) : 큐 뒤에 요소 e 추가
    // LinkedList는 용량 제한이 없어서 항상 true 반복
    ...
    System.out.println("----- 큐 맨앞 요소 제거 - poll -----");

    // 큐가 비어있을 경우 null 반환
    System.out.println("pull() 결과 : " + queue.poll()); // 1ㅈㅔ거
    System.out.println("pull() 후 결과 : " + queue);     // [2, 3]
    System.out.println("pull() 결과 : " + queue.poll()); // 2제거
    System.out.println("pull() 후 결과 : " + queue); // [3]
    System.out.println("pull() 결과 : " + queue.poll()); // 3제거
    System.out.println("pull() 후 결과 : " + queue); // []
    System.out.println("pull() 결과 : " + queue.poll()); // 비어있어서 null 반환

    System.out.println("----- 큐가 비어있는지 확인 -isEmpty() -----");
    System.out.println("isEmmpty() : " + queue.isEmpty());
