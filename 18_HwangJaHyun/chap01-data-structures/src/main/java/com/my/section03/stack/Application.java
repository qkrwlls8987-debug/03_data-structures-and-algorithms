package com.my.section03.stack;
...
*  java 제공 stack 클래스
* java.util 패키지
* Vector 클래스(List 비슷, 내부 배열 사용)을 상속하여 만들어짐
...
public class Application {
  public static void main(String[] args) {
    ...
    // EmptuStackException이 발생한다.
    // if문 or Try/Catch문 사용해주기
    if(stack != null && !stack.isEmpty()){
      System.out.println("peak() 결과 : " + stack.peek());
      System.out.println("peak() 호출 후 결과 : " + stack);
    }
